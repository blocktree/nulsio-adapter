...
func TestTransfer(t *testing.T) {
	...
	to := "NsdunqqvoSYMne6XxTckQrqYfJZJfnwy"
	...
	rawTx, err := testCreateTransactionStep(tm, walletID, accountID, to, "", "", nil)
	if err != nil {
		return
	}
...
func TestTransferNrc20(t *testing.T) {
	...
	for _,a := range address{
		...
		rawTx, err := testCreateTransactionStep(tm, walletID, accountID, a, "10", "", contract)
		if err != nil {
			return
		}
